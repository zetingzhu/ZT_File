...
val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "preference_settings_latest")

val globalDataStore: DataStore<Preferences> = MyApplication.getInstance().dataStore
